...
# KEY_N
#============================================================
 #set_location_assignment PIN_AA14 -to i_Reset
 #set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to i_Reset
 set_location_assignment PIN_AA15 -to i_ButtonInput
 set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to i_ButtonInput
...
# SW
#============================================================
set_location_assignment PIN_AB12 -to i_Reset
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to i_Reset
...
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to o_sclk_dc
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to i_miso_dc
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to o_mosi_dc
# set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to o_ss_dc
...
#============================================================
set_location_assignment PIN_AC18 -to mosi_dc
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to mosi_dc  
set_location_assignment PIN_Y17 -to sclk_dc
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to sclk_dc
set_location_assignment PIN_AD17 -to ss_dc
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to ss_dc
set_location_assignment PIN_Y18 -to i_miso_dc
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to i_miso_dc
